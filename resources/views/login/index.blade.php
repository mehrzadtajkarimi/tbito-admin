                ...
                <div class="card card-info mt-5 shadow ">
                    ...
                    <form class="form-horizontal" action="{{ route('login') }}" method="post">
                        ...
                        <div class="card-body" style="direction: ltr;">
                            ...
                            <div class="form-group">
                                <label for="input3" class="col-sm-2 control-label">ورود دوعاملی</label>
                                <div class="col-sm-12">
                                    <input autocomplete="off" type="text" name="otp" class="form-control" id="input3" placeholder="otp" >
                                </div>
                            </div>
                        </div>
